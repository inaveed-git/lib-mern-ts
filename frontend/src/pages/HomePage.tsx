...
const HomePage: React.FC = () => {
        ...
        const fetchPublicLibraries = async () => {
            try {
                ...
                if (response.data.success) {
                    // Ensure we have books array with cover images
                    const librariesWithBooks = response.data.data.map((library: any) => ({
                        ...library,
                        books: library.books || [] // Ensure books array exists
                    }));
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0f1a2f] to-[#1a2a3a] text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold mb-4">Welcome to ShelfLib</h1>
                ...
                <div className="mb-8 flex justify-between items-center">
                    <h2 className="text-2xl font-bold">Public Libraries</h2>
