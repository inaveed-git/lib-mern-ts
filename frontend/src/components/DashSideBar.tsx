        ...
        <div className="fixed top-0 left-0 bottom-0 w-full md:w-56 bg-gradient-to-br from-[#1e3a5f] to-[#2d5182] text-white p-4 flex flex-col z-10 overflow-y-auto">
            ...
            <nav className="flex-1">
                <ul>
                    ...
                    <li className="mb-1">
                        ...
                        >
                            <span className="text-[#65a3e0] mr-3"><IoLibrary className="text-xl" /></span>
            ...
            <div className="mt-auto p-3 bg-[rgba(0,0,0,0.2)] rounded-lg border-l-4 border-[#65a3e0]">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3 text-balance">
                        <div className="bg-gray-200 border-2 border-dashed rounded-xl w-10 h-10 " />
                        <div>
                            {/* {user?.username.slice(1, 5)} */}
                            <p className="font-medium">
                                {user?.username?.length > 8 ? `${user?.username.slice(0, 8)}...` : user?.username || 'User'}
                            </p>
